package com.feicui.recyclerlistview.helper;

import android.graphics.Canvas;
import android.support.v7.widget.RecyclerView;
import android.support.v7.widget.helper.ItemTouchHelper;

import com.feicui.recyclerlistview.RecyclerListAdapter;
...
//        return makeMovementFlags(dragFlags, 0);//第二项为0，表示你支持拖拽，不支持左右滑动
     ...
     * boolean)} or
     * {@link (Canvas, RecyclerView, RecyclerView.ViewHolder, float, float, int, boolean)}.
